        ...
        <form onSubmit={handleSubmit(handleFormSubmit)} className="p-6 md:p-10 space-y-6 md:space-y-8 bg-white/90">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            ...
            <button
              ...
              className="order-1 sm:order-2 flex-[2] btn-modern px-8 md:px-12 py-4 md:py-5 rounded-xl md:rounded-2xl shadow-xl shadow-yellow-500/20 active:scale-95 transition-transform bg-yellow-500 text-white font-black uppercase tracking-widest text-[10px] md:text-xs"
            >
