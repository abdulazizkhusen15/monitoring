  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
      ...
      <div className="relative w-full max-w-xl glass-card-strong rounded-[32px] md:rounded-[48px] overflow-hidden border-white shadow-2xl animate-in fade-in zoom-in duration-300">
        <div className={`p-6 md:p-10 text-white relative overflow-hidden ${type === 'OUT' ? 'bg-gradient-to-br from-purple-500 to-purple-700' : 'bg-gradient-to-br from-amber-400 to-amber-600'}`}>
